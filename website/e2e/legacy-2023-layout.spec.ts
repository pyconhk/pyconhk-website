...
const archive = JSON.parse(
  fs.readFileSync(
    path.join(process.cwd(), 'src/years/2023/data/archive.json'),
    'utf8'
  )
) as LegacyArchive;
...
test('legacy 2023 pagination routes first page to the year root', async ({
  page,
}) => {
