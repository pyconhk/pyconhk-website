...
import { canonicalSpeakerName, createSpeakerDirectory, speakerIdentity, speakerRedirects } from '../src/lib/programme/speakers.ts';
...
test('legacy identities stay unchanged and redirect to directory URLs within each locale', () => {
