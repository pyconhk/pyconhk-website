...
Astro 7 requires a modern Node runtime for its tooling even when Bun is the package manager and script runner. The repository pins Node 24.18.0 and Bun 1.3.10 in mise config.
...
- Developer onboarding and CI should provision Node 24.18.0 and Bun 1.3.10 through mise.
- Developer onboarding and deployment settings should use Node 24.18.0.
